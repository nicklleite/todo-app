<template>
    <li class="list-group-item py-3">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <input class="form-check-input mt-0" type="checkbox" :class="completedTaskClass" :checked="task.is_completed" @change="markTaskAsCompleted" />
        ...
        <TaskAction @edit="($event) => (isEdit = true)" v-show="isEdit === false" @remove="removeTask" />
    </li>
</template>
